    ...
    >
      ...
      <div
        ...
        style={{
          background:
            theme === "dark"
              ? "linear-gradient(180deg, rgba(5,8,26,0.86) 0%, rgba(5,8,26,0.68) 20%, rgba(5,8,26,0.82) 38%, rgba(5,8,26,0.88) 50%, rgba(5,8,26,0.66) 60%, rgba(5,8,26,0.34) 74%, rgba(5,8,26,0.82) 100%)"
              : "linear-gradient(180deg, rgba(244,246,251,0.88) 0%, rgba(244,246,251,0.70) 20%, rgba(244,246,251,0.84) 38%, rgba(244,246,251,0.90) 50%, rgba(244,246,251,0.68) 60%, rgba(244,246,251,0.36) 74%, rgba(244,246,251,0.85) 100%)",
        }}
      />
